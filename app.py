    ...
    [
            ...
            [
                html.Div(
                    [
                        ...
                        html.Div(children = [], 
                                id='globe-container',
                                style={"background-color": "#343a40", "position":"relative", 'height':'85%'})
                    ],
        ...
        html.Div(
            [
                ...
                dcc.Graph(id="benchmark_scatter"),
            ],
...
def update_graph_location(clickData,
    ...
    return (
        dash_deck.DeckGL(
                    json.loads(get_globe(lat,lon).to_json()),
                    id="globe-chart",
                    tooltip=True,
                ),
        dash_deck.DeckGL(
...
def get_subzone(lat, lon, location, filter):
    ...
    geojson = pydeck.Layer(
        ...
        extruded=True,
        wireframe=True,
        get_elevation= f'properties.{filter}',
        elevation_scale = 5,
